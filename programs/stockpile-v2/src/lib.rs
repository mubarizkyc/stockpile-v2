...
pub mod stockpile_v2 {
    ...
    pub fn contribute(ctx: Context<Contribute>, _project_id: u64, amount: u64) -> Result<()> {
    ...
    pub fn fund_pool(ctx: Context<FundPool>, _pool_id: u64, amount: u64) -> Result<()> {
    ...
    pub fn claim_payout(ctx: Context<ClaimPayout>, _project_id: u64, _pool_id: u64) -> Result<()> {
        instructions::claim_payout(ctx, _project_id, _pool_id)
    }

    pub fn withdraw_funds_from_round(ctx: Context<WithdrawFromRound>, _pool_id: u64) -> Result<()> {
    ...
    pub fn realloc_pool(ctx: Context<ReallocPool>, _pool_id: u64) -> Result<()> {
